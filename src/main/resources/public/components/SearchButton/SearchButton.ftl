...
[#--    [/@Button]--]
    ...
    <link rel="stylesheet" type="text/css" href="/components/SearchButton/style1.css" />
    <link rel="stylesheet" type="text/css" href="/components/SearchButton/demo.css" />
    ...
    <svg class="hidden">
        <defs>
            ...
            <symbol id="icon-cross" width="24" height="24" viewBox="0 0 24 24">
                <title>cross</title>
    ...
    <script src="/components/SearchButton/demo1.js"></script>
[/#macro]